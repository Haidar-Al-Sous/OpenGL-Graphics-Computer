...
void DrawGLScene(GLvoid)									// Here's Where We Do All The Drawing
{
	...
	glTranslated(0,0,-20);
		...
		if(keys[VK_RIGHT]&&keys[VK_UP])
		z+=0.1;
	else	if(keys[VK_LEFT]&&keys[VK_UP])
		z-=0.1;
...
glRotated(angle*1.5,0,-1,0);
   ...
   glRotated(angle*0.25,0,1,0);
	...
	for (aa = 0.0f; aa <= (2.0f*3.14f); aa += 0.1f)
	{
	 int cc=aa;
	 int c=a;
		if (cc%4==0||cc%6==0||cc%10==0||cc%11==0||c%3==0)
			glColor3f(0,0,1);
		else 
				glColor3f(0,1,0);
	...
	//القمر
	glScaled(0.666,0.666,0.666);
	glRotated(angle*3,1,1,0);
	glScaled(1.5,1.5,1.5);
...
glTranslated(0,0,-2);
	...
	for (float aa = 0.0f; aa <= (2.0f*3.14f); aa += 0.05f)
	{
			float x = 2* r*cos(aa);
	float y = 2* r*sin(aa);
	glVertex3f(y, 0, x);
	glVertex3f(y, 0+0.1, x);
	glVertex3f(y, 0-0.1, x);
	}
	for (float aa = 0.0f; aa <= (2.0f*3.14f); aa += 0.05f)
	{
			float x = 2.2* r*cos(aa);
	float y = 2.2* r*sin(aa);
	glVertex3f(y, 0, x);
	glVertex3f(y, 0+0.1, x);
	glVertex3f(y, 0-0.1, x);
	}
	for (float aa = 0.0f; aa <= (2.0f*3.14f); aa += 0.05f)
	{
			float x = 2.4* r*cos(aa);
	float y = 2.4* r*sin(aa);
	glVertex3f(y, 0, x);
	glVertex3f(y, 0+0.1, x);
	glVertex3f(y, 0-0.1, x);
	}
...
glTranslated(0,0,-2);
	...
	glBegin(GL_POINTS);
	glColor3f(0.5,0.85,1);
	for (float aa = 0.0f; aa <= (2.0f*3.14f); aa += 0.005f)
	{
			float x = 2* r*cos(aa);
	float y = 2* r*sin(aa);
	glVertex3f(y, 0, x);
